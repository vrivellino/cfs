...
my $dir = shift or die "I need a directory.";
...
foreach my $html_file ( @html_files) {
	...
	print join(',', $team, $conf, $games, $wins, $losses, $ppg, $opp_ppg, $o_pass_yds, $o_rush_yds,
	                $o_pen_yds, $o_to, $d_pass_yds, $d_rush_yds, $d_pen_yds, $d_to), "\n";
}
